<?php
    ...
    class Permissions
    {
        ...
        private static function CreatePermissionSeedForEntity() {
            ...
            $namespace = "{$data['namespace']}\Base\Authorization\Permission";
            ...
            $repositoryContent = str_replace(
                ...
                [
                    ...
                    $namespace, $data['base'],Str::lower($data['name'])], $dummyContent);
            $data['file']->put($destinationPath, $repositoryContent);
        }

        private static function CreatePermissionModel($data) {
            if(!$data['file']->exists("{$data['base']}/Base/Authorizations/Permission.php")) {
                $fullModelName = "{$data['base']}/Base/Authorizations/Permission";
